...
namespace ysn
{
	...
	bool ConvertToCubemap::Initialize()
	{
		...
		if (!result)
		{
			std::cerr << "Can't create ConvertToCubemap root signature\n";
			return false;
		}
		...
		{
			std::cerr << "Can't compile ConvertToCubemap vs shader\n";
			return false;
		}
		...
		{
			std::cerr << "Can't compile ConvertToCubemap ps shader\n";
			return false;
		}
		...
		{
			std::cerr << "Can't create ConvertToCubemap pipeline state object :" << ConvertHrToString(hr_result) << "\n";
			return false;
		}
