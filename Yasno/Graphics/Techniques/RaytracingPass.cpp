...
namespace ysn
{
	...
	bool RaytracingPass::CreateRaytracingPipeline(std::shared_ptr<ysn::DxRenderer> renderer)
	{
		...
		{
			LogFatal << "Can't compile ray gen shader\n";
			return false;
		}
		...
		{
			LogFatal << "Can't compile miss shader\n";
			return false;
		}
		...
		{
			LogFatal << "Can't compile hit shader\n";
			return false;
		}
		...
		{
			LogFatal << "Can't QueryInterface rt_state_object_props from CreateRaytracingPipeline\n";
			return false;
		}
												  ...
												  uint32_t primitives_count)
	{
		...
		if (!m_sbt_storage)
		{
			LogFatal << "Could not allocate the shader binding table\n";
			return false;
		}
