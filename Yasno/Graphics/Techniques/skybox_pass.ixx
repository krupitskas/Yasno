...
namespace ysn
{
	bool SkyboxPass::Initialize()
	{
		...
		{
			std::cerr << "Can't compile SkyBox vs shader\n";
			return false;
		}
		...
		{
			std::cerr << "Can't compile Skybox ps shader\n";
			return false;
		}
		...
		{
			std::cerr << "Can't create SkyBox pipeline state object :" << ConvertHrToString(hr_result) << "\n";
			return false;
		}
